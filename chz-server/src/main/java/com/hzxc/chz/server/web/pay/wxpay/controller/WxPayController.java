...
// {"appid":"wx2421b1c4370ec43b","attach":"支付测试","body":"JSAPI支付测试","mchId":"10000100","detail": "{'goods_detail':[{'goods_id':'iphone6s_16G','wxpay_goods_id':'1001','goods_name':'iPhone6s 16G','quantity':1,'price':528800,'goods_category':'123456','body':'苹果手机'},{'goods_id':'iphone6s_32G','wxpay_goods_id':'1002','goods_name':'iPhone6s 32G','quantity':1,'price':608800,'goods_category':'123789','body':'苹果手机'}]}","nonce_str":"1add1a30ac87aa2db72f57a2375d8fec","notifyUrl":"http://wxpay.wxutil.com/pub_v2/pay/notify.v2.php","openid":"oUpF8uMuAJO_M2pxb1Q9zNjWeS6o","outTradeNo":"1415659990","spbillCreateIp":"14.23.150.211","totalFee":"1","tradeType":"JSAPI","sign":"0CB01533B8C1EF103065174F50BCA001"}
@RestController
@RequestMapping("/pay")
...
//  @GetMapping("/closeOrder/{outTradeNo}")
  @RequestMapping(value = "/closeOrder/{outTradeNo}", method = {RequestMethod.GET , RequestMethod.POST})
...
//  @PostMapping("/refund")
   ...
   */
  @Override
  @RequestMapping(value = "/refundQuery", method = {RequestMethod.GET, RequestMethod.POST })
//  @GetMapping("/refundQuery")
   ...
   */
  @Override
  @RequestMapping(value = "/parseOrderNotifyResult", method = {RequestMethod.GET , RequestMethod.POST})
//  @PostMapping("/parseOrderNotifyResult")
   ...
   */
  @Override
  @RequestMapping(value = "/parseRefundNotifyResult", method = {RequestMethod.GET , RequestMethod.POST})
//  @PostMapping("/parseRefundNotifyResult")
   ...
   */
  @Override
  @RequestMapping(value = "/parseScanPayNotifyResult", method = {RequestMethod.GET , RequestMethod.POST})
//  @PostMapping("/parseScanPayNotifyResult")
   ...
   */
  @Override
  @RequestMapping(value = "sendRedpack", method = {RequestMethod.GET , RequestMethod.POST})
//  @PostMapping("sendRedpack")
   ...
   */
  @Override
  @RequestMapping(value = "/queryRedpack/{mchBillNo}", method = {RequestMethod.GET , RequestMethod.POST})
//  @GetMapping("/queryRedpack/{mchBillNo}")
   ...
   * @param request 请求对象
   */
  @RequestMapping(value = "/entPay", method = {RequestMethod.GET , RequestMethod.POST})
//  @PostMapping("/entPay")
   ...
   */
  @RequestMapping(value = "/queryEntPay/{partnerTradeNo}", method = {RequestMethod.GET , RequestMethod.POST})
...
//  @PostMapping("/report")
   ...
   */
  @Override
  @RequestMapping(value = "/downloadBill", method = {RequestMethod.GET , RequestMethod.POST})
...
//  @PostMapping("/micropay")
   ...
   */
  @Override
  @RequestMapping(value = "/reverseOrder", method = {RequestMethod.GET , RequestMethod.POST})
//  @PostMapping("/reverseOrder")
  ...
  @Override
  @RequestMapping(value = "/getSandboxSignKey", method = {RequestMethod.GET , RequestMethod.POST})
...
//  @PostMapping("/sendCoupon")
  ...
  @Override
  @RequestMapping(value = "/queryCouponStock", method = {RequestMethod.GET , RequestMethod.POST})
//  @PostMapping("/queryCouponStock")
  ...
  @Override
  @RequestMapping(value = "/queryCouponInfo", method = {RequestMethod.GET , RequestMethod.POST})
